...
{
  USBD_MSC_Init,         //xxxx->USBD_SetupStage()->USBD_StdDevReq()-->USBD_SetConfig()-->USBD_SetCfg()-->USBD_MSC_Init()
  USBD_MSC_DeInit,       //DCD_OTG_ISR()-->USBD_DevDisconnected()-->USBD_MSC_DeInit()      (When defien VBUS_SENSING_ENABLED)
  USBD_MSC_Setup,        //DCD_HandleOutEP_ISR()-->USBD_SetupStage()-->USBD_StdEPReq()-->USBD_MSC_Setup()
  NULL, /*EP0_TxSent*/  
  NULL, /*EP0_RxReady*/
  USBD_MSC_DataIn,       //DCD_HandleInEP_ISR()-->USBD_DataInStage()-->USBD_MSC_DataIn()
  USBD_MSC_DataOut,      //DCD_HandleOutEP_ISR()-->USBD_DataOutStage()-->USBD_MSC_DataOut()
  NULL, /*SOF */         //DCD_HandleSof_ISR()-->USBD_SOF()-->This
  NULL,                  //DCD_IsoINIncomplete_ISR()-->USBD_IsoINIncomplete()-->This
  NULL,                  //DCD_IsoOUTIncomplete_ISR()-->USBD_IsoOUTIncomplete()-->This
  USBD_MSC_GetCfgDesc,   //USBD_GetDescriptor() pdev->dev.class_cb->GetConfigDescriptor
#ifdef USB_OTG_HS_CORE  
  USBD_MSC_GetOtherCfgDesc,  //USBD_GetDescriptor() pdev->dev.class_cb->GetOtherConfigDescriptor
#endif
};
  ...
  case USB_REQ_TYPE_CLASS :
    ...
    case BOT_GET_MAX_LUN :
         ...
         ((req->bmRequest & 0x80) == 0x80))
      {
        ...
        {
			my_printf("[%s] USBD_MSC_MaxLun=%d\n\r", __FUNCTION__, USBD_MSC_MaxLun);

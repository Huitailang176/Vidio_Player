...
/** @defgroup USBD_MEM_Exported_FunctionsPrototype
  * @{
  */
//USBD_STORAGE_fops结构的成员函数在usbd_storage_msd.c中实例化
//USBD_STORAGE_fops结构的成员函数在实现scsi协议时调用(usbd_msc_core.c usbd_msc_scsi.c等文件)
extern const USBD_STORAGE_cb_TypeDef *USBD_STORAGE_fops;
/**
  * @}
  */ 

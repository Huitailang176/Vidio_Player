...
{
  USBD_USR_DeviceDescriptor,            //USBD_GetDescriptor() pdev->dev.usr_device->GetDeviceDescriptor
  USBD_USR_LangIDStrDescriptor,         //USBD_GetDescriptor() pdev->dev.usr_device->GetLangIDStrDescriptor
  USBD_USR_ManufacturerStrDescriptor,   //USBD_GetDescriptor() pdev->dev.usr_device->GetManufacturerStrDescriptor
  USBD_USR_ProductStrDescriptor,        //USBD_GetDescriptor() pdev->dev.usr_device->GetProductStrDescriptor
  USBD_USR_SerialStrDescriptor,         //USBD_GetDescriptor() pdev->dev.usr_device->GetSerialStrDescriptor
  USBD_USR_ConfigStrDescriptor,         //USBD_GetDescriptor() pdev->dev.usr_device->GetConfigurationStrDescriptor
  USBD_USR_InterfaceStrDescriptor,      //USBD_GetDescriptor() pdev->dev.usr_device->GetInterfaceStrDescriptor
